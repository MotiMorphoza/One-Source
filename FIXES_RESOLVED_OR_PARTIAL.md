...
### Library row entries are now shown on one line
...
### Mobile Library overflow is now handled without collapsing the layout
...
### The bundled HUB header now uses a deeper vivid purple
